...
public class Main {
    public static void main(String[] args) {
        try {
            ...
            String jsonPath = "resources/json/liga.json"; // <- ajusta se necessário

            // Importar ligas do ficheiro JSON
            League[] ligas = LeagueImporterJSON.leaguesFromJson(jsonPath);
            ...
            // Usar a primeira liga
            ILeague liga = ligas[0];
